document.addEventListener('DOMContentLoaded', () => {
    ...
    function displayTeam(team) {
        ...
        thead.innerHTML = `
            <tr>
                <th style="width: 40%; text-align: left; padding: 8px; border-bottom: 1px solid #00cccc; color: #00ffff;">Player Name</th>
                <th style="width: 30%; text-align: left; padding: 8px; border-bottom: 1px solid #00cccc; color: #00ffff;">Role</th>
        ...
        // Add each player as a row in the table
        sortedTeam.forEach(player => {
            const row = document.createElement('tr');
            row.innerHTML = `
                <td style="padding: 6px; border-bottom: 1px solid #004d4d; color: #ffffff;">${player.fullName}</td>
                <td style="padding: 6px; border-bottom: 1px solid #004d4d; color: #ffffff;">${player.position === 'Batsman' ? 'Batsmen' : player.position}</td>
                <td style="padding: 6px; border-bottom: 1px solid #004d4d; color: #ffffff;">${player.Current_Team}</td>
            `;
